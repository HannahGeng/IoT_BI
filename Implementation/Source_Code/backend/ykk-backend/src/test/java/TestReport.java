...
public class TestReport {
    ...
    public void testAlarmTrend(){
        ...
        List<TrendPoint> trendPointList = reportService.getAlarmTrend("2022-01-01", "2022-09-30", 3);
    ...
    public void testQuotaTrend(){
        List<TrendPoint2> trendPoint2List = reportService.getQuotaTrend("2022-04-20 00:00:00", "2020-04-30 23:59:59"
                , "1", "100001", 3);
