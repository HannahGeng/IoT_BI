  ...
  <div class="equipment-container">
    ...
    <div class="seachBox">
        ...
        <el-form-item label="equipment:">
          <el-input v-model="formInline.sn" placeholder="please enter equipment number"></el-input>
        </el-form-item>
        <el-form-item label="label">
          <el-input v-model="formInline.tag" placeholder="please enter lable"></el-input>
        </el-form-item>
    ...
    <div class="contBox">
        <div v-for="(item, ind) in tableData" :class="['item', {'active': item.status}]"  :key="ind">
           ...
           <div class="topList" >
            ...
            <div class="labList">
                <div class="tit">equipment label</div>
...
export default class extends Vue {
 ...
 //查询
  ...
  private async handleClick(row: any) {
    ...
    if (!data) {
      this.$message.error(data.message || 'request failed')
    }
  }
