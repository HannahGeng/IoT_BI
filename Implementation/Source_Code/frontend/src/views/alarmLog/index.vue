  ...
  <div class="alarmLog-container">
    ...
    <div class="seachBox">
        ...
        <el-form-item label="Alarm name:" class="taglong">
          <el-input v-model="formInline.alarmName" placeholder="Please enter the alarm name"></el-input>
        </el-form-item>
        <el-form-item label="Alarm equipment：" class="taglong">
          <el-input v-model="formInline.deviceId" placeholder="Please enter the equipement number"></el-input>
        </el-form-item>
        <!-- <el-form-item label="状态：" class="tagSearch">
          <el-input v-model="formInline.tags" placeholder="请输入"></el-input>
        </el-form-item> -->
        <el-form-item label="Time：" class="tagSearch" >
          <el-date-picker
            v-model="timeVal"
            :clearable="false"
            type="daterange"
      ...
      <div :class="{'item': true, 'itemLev': item.level == 1}" v-for="(item,index) in tableData" :key="index">
        ...
        <div class="itemInfo">
          ...
          <div style="text-align: left;padding-left: 160px;">
            ...
            <span v-if="item.level == 1" class="labLev">general</span>
            <span v-if="item.level == 2" class="labLev">severe</span>  
            </div>
