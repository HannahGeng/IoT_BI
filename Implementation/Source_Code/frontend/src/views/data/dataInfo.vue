  ...
  <div class="data-container">
      <div class="seachBox">
          ...
          <el-form-item label="status:">
            <el-select v-model="formInline.state" placeholder="all">
              <el-option label="all" value="4"></el-option>
              <el-option label="online" value="0"></el-option>
              <el-option label="offline" value="1"></el-option>
              <el-option label="general alarm" value="2"></el-option>
              <el-option label="severe alarm" value="3"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="tags:">
            <el-input v-model="formInline.tag" placeholder="please enter the equipment tag"></el-input>
          </el-form-item>
          <el-form-item label="equipment:">
            <el-input v-model="formInline.deviceId" placeholder="please enter the quipment ID"></el-input>
          </el-form-item>
          <div class="searchBut" style="display:inline-block" @click="onSubmit"><i class="iconfont icon-sousuo"></i> search</div>
        </el-form>
      </div>
      <div class="contBox"  v-infinite-scroll="handleCurrentChange" style="overflow:auto" v-loading="loading" infinite-scroll-immediate="false">
         <div v-for="(item, ind) in tableData" :class="['item', calssName(item)]"  :key="ind">
           <div class="lable" v-if="item.level == 0"> <span class="hov">{{item.online ? 'online' : 'offline'}} </span></div>
           <div class="lable" v-if="item.level != 0"> <span class="hov">{{item.level == 1 ? 'general alarm' : 'severe alarm'}}</span></div>
           ...
           <div class="info" >
             <div v-for="(it, ind) in item.quotaList" :key="ind">
               ...
               <span style="color:#818693">general value &nbsp; {{it.referenceValue}} {{it.unit}} </span>
              </div>
           </div>
      ...
      >
        ...
        <div class="dataInfo" >
          <div v-for="(it, ind) in itemData.quotaList" class="item" :key="ind">
            ...
            <span style="color:#818693">reference value &nbsp; {{it.referenceValue}} {{it.unit}} </span>
          </div>
        </div>
      <div
        slot="footer"
